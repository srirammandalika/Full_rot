...
class MainTrain(object):
    def __init__(self, opt) -> None:
        ...
        self.opt = opt  # Set the opt parameter in init
        self.paramsInit(opt)  # Initialize parameters (includes setting device)
        self.filePathInit(opt)
        self.logFieldInit(opt)

    def paramsInit(self, opt):
        # Ensure device initialization with MPS support check
